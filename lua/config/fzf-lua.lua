...
keymap("n", "<leader>bm", ":FzfLua git_bcommits<CR>", noshow)
keymap("n", "gw", ":FzfLua grep_cword<CR>", noshow)
keymap("n", "<leader>L", ":FzfLua live_grep_resume<CR>", noshow)
keymap("n", "<leader><leader>b", ":FzfLua buffers<CR>", noshow)
keymap("n", "<leader>cg", ":FzfLua changes<CR>", noshow)
keymap("n", "<leader>co", ":FzfLua colorschemes<CR>", noshow)
-- keymap(
-- 	"n",
-- 	"die",
-- 	":lua require('fzf-lua').lsp_document_diagnostics({winopts = {split = 'belowright new', preview = {hidden = 'hidden'}}})<CR>",
-- 	noshow
-- )
-- keymap(
-- 	"n",
-- 	"dia",
-- 	":lua require('fzf-lua').lsp_workspace_diagnostics({winopts = {split = 'belowright new', preview = {hidden = 'hidden'}}})<CR>",
-- 	noshow
-- )
