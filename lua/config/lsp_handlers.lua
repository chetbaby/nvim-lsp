...
local function lsp_highlight_document(client) -- highlights symbol on hover (i don't use this)
...
local function lsp_keymaps(bufnr)
  ...
  vim.cmd([[ command! Format execute 'lua vim.lsp.buf.format()' ]]) -- :Format command
end
